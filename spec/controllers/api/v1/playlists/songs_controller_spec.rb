...
RSpec.describe Api::V1::Playlists::SongsController, type: :controller do
  let(:json_body) do
  ...
  describe "GET #index" do
    ...
    it "should provide a list of playlists" do
      subject
      expect(data.first[:id]).to eq(playlist.id)
    end

    context "pagination" do
      before do
        30.times { create(:playlist) }
      end
  ...
  describe "GET #show" do
    ...
    it "should show the playlist" do
      subject
      expect(data[:name]).to eq(playlist.name)
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "should delte the playlist" do
      expect { subject }.to change { Playlist.count }.by(-1)
    end
